...
#ifndef LEARNINGOPENGL_1_CAMERA_H
#define LEARNINGOPENGL_1_CAMERA_H
...
public:
    ...
    explicit Camera(const glm::vec3& position = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f),
...
#endif //LEARNINGOPENGL_1_CAMERA_H
